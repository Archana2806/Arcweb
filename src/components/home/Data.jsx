...
const Data = () => {
    const words = ['Thinker', 'Researcher', 'Problem Solver', 'Developer', 'Programmer', 'Explorer'];
    const interval = 1000; // 0.1 seconds in milliseconds

  return (
    <div className="home__data">
        <h1 className="home__title">
            Hi, I am <br /> Archana Mohanty
        </h1>
        <h3 className="home__subtitle">
             <WordRotator words={words} interval={interval} />
        </h3>
